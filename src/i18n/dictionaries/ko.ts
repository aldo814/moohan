export const ko = {
  ...
  home: {
    ...
    contact: {
      title: "문의하기", description: "문의해 주셔서 감사합니다. 담당 팀이 내용을 확인한 후 영업일 기준 1일 이내에 답변드리겠습니다.", firstName: "이름", lastName: "성", company: "회사", email: "이메일", phone: "전화번호", message: "문의 내용", attachment: "첨부파일", dropGuide: "첨부할 파일을 여기에 끌어 놓거나 파일 선택 버튼을 눌러주세요.", uploadGuide: "업로드 가능 파일: JPG, GIF, DOCX, PPTX, MD, PDF (파일당 최대 10MB)", noFile: "선택된 파일이 없습니다.", selectedFiles: "{count}개 파일이 선택되었습니다.", chooseFile: "파일 선택", removeFile: "삭제", submit: "보내기", sending: "전송 중…", success: "감사합니다. 문의가 정상적으로 전송되었습니다.", error: "문의를 전송할 수 없습니다. 다시 시도해 주세요.", invalidFile: "JPG, GIF, DOCX, PPTX, MD, PDF 파일만 첨부할 수 있으며 파일당 최대 용량은 10MB입니다." },
