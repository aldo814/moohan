export const ko = {
  meta: { siteName: "무한기술번역", home: { title: "HOME", description: "2006년부터 축적된 특허번역 전문성과 최첨단 AI 기술의 결합" } },
  common: {
    languageSwitcher: { label: "Language" },
    navigation: { home: "HOME", about: "ABOUT US", services: "SERVICES", technologies: "TECHNOLOGIES", contact: "CONTACT US" },
    homeLabel: "무한 홈", primaryNavigation: "주요 메뉴", footerNavigation: "하단 메뉴", login: "TMS Login", backToTop: "맨 위로",
  },
  home: {
    hero: {
    ...
    services: {
      ...
      items: [
        { number: "01", title: "PCT 국내 단계 번역", description: "각국 특허청의 출원 형식과 규정에 부합하는 PCT 국내 단계 진입 번역을 제공합니다." },
        { number: "02", title: "일반출원 번역", description: "우선권 주장 기간 내에 각국 특허청에 개별적으로 직접 출원 시에 이에 적합한 형식으로 번역을 제공합니다." },
        { number: "03", title: "중간사건 서류 번역", description: "의견제출통지서, 거절결정서 등 중간사건 서류 및 이에 대응하는 의견서, 보정서에 대한 번역을 제공합니다." },
        { number: "04", title: "IP 및 소송 관련 자료 번역", description: "IP 관련 법령, 심결문, 판결문 및 특허 침해·분쟁 자료 등 높은 법률적·기술적 이해도를 요구하는 전문 문서에 대한 번역을 제공합니다." },
      ],
    ...
    technologies: {
      ...
      preparation: "Coming Soon", workflowLabel: "번역 기술 워크플로", projectSetup: "PM: 프로젝트 설정", connected: "파일·TM·TB·AI 엔진 연결", platform: "클라우드 기반 번역 플랫폼", environment: "TM·TB·NMT/LLM 통합 환경", translator: "번역가", reviewer: "검수자", nmtTranslation: "NMT/LLM 번역", initialDraft: "1차 번역 초안 생성", ruleQa: "규칙 기반 QA", finalCheck: "제출 전 최종 점검", reviewCheck: "검수 단계 재확인", llmPostEditing: "LLM 포스트 에디팅", revision: "교차 검증 및 수정안 제공", complete: "검수 완료 번역물",
    },
    contact: {
      title: "CONTACT US", description: "무한기술번역에 문의해 주셔서 감사합니다.\n담당자가 문의 내용을 검토한 후, 영업일 기준 1일 이내에 회신드리겠습니다.", firstName: "성함", lastName: "성", company: "회사명", email: "이메일", phone: "연락처", message: "문의 내용", attachment: "첨부파일", dropGuide: "파일을 여기로 드래그하거나 클릭하여 선택하세요.", uploadGuide: "업로드 가능한 파일 형식: JPG, GIF, DOCX, PPTX, XLSX, PDF (파일당 최대 10MB)", noFile: "선택된 파일이 없습니다.", selectedFiles: "{count}개 파일이 선택되었습니다.", removeFile: "삭제", privacyPolicy: "개인정보처리방침", termsOfService: "이용약관", viewDetails: "상세보기", close: "닫기", agreementRequired: "개인정보처리방침과 이용약관에 동의해 주세요.", submit: "문의하기", sending: "전송 중…", success: "감사합니다. 문의가 정상적으로 접수되었습니다.", error: "문의를 접수할 수 없습니다. 다시 시도해 주세요.", invalidFile: "JPG, GIF, DOCX, PPTX, XLSX, PDF 파일만 첨부할 수 있으며 파일당 최대 용량은 10MB입니다." },
	  footer: { tel: "Tel", telValue: "02-564-7789", fax: "Fax", faxValue: "02-6442-0787", contact: "Email", address: "Address", addressValue: "서울시 금천구 가산디지털2로 169-16, 518호(가산동, 하우스디가산퍼스타)", copyright: "©2026 MOOHAN Technical Translation Services Co., Ltd." },
  },
};
